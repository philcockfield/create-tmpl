...
### Introduction
Compose one or more directories and files together with glob patterns into a powerful `tmpl` that can be copied anywhere...to the file-system, to memory, wherever.
